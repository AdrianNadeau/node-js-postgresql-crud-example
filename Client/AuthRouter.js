const db = require("../Server/models/server");
var express = require('express');
require("dotenv").config()
var Authrouter = express.Router();

const companies = require("./../Server/controllers/company.controller");
const persons = require("./../Server/controllers/person.controller");
